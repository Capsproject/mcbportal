	...
	<div class="col-md-4"><label>Academic Year - <?php echo $_SESSION['SY'] ; ?></label></div>
		<table class="table">
			...
			<tr>
				...
				<td >
					<input class="form-control input-md" readonly id="studentid" name="studentid" placeholder="Student No" type="text" value="<?php echo isset($_SESSION['studentid']) ? $_SESSION['studentid'] : '' ?>">
				</td>
				<td colspan="4"></td>
