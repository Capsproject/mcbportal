...
?>
 ...
 <form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
      ...
      <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header">Learning Materials</h1>
          </div>
          <!-- /.col-lg-12 `SUBJ_CODE`, `SUBJ_DESCRIPTION`, `UNIT`, `PRE_REQUISITE`, `COURSE_ID`, `AY`, `SEMESTER`-->
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <input class="form-control input-sm" id="module" name="module" placeholder=
                            "Module" type="text" value="<?php echo $res->module; ?>" >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <input class="form-control input-sm" id="act" name="act" placeholder=
                            "Activities" type="text" value="<?php echo $res->act; ?>" >
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <input class="form-control input-sm" id="quiz" name="quiz" placeholder=
                            "Quiz" type="text" value="<?php echo $res->quiz; ?>" >
                      </div>
                    </div>
                  </div>
                  ...
                  <?php
// Set your condition to determine whether to show the form or not
$showForm = false; // Change this based on your specific condition
?>
             ...
             <div class="form-group" >
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <input type="Hidden"  class="form-control input-sm" id="SUBJ_DESCRIPTION" name="SUBJ_DESCRIPTION" placeholder=
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <input class="form-control input-sm" id="UNIT" name="UNIT" placeholder=
                            "Unit" type="Hidden" value="<?php echo $res->UNIT; ?>" required>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <input class="form-control input-sm" id="PRE_REQUISITE" name="PRE_REQUISITE" placeholder=
                            "Pre-Requisite" type="Hidden" value="<?php echo $res->PRE_REQUISITE; ?>" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group" <?php echo $showForm ? '' : 'style="display:none;"'; ?>>
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
